...
| 4 | 指標カード（3 年止血・年間創出・3 年創出の並列） | [`result-dashboard.md §3.2`](./result-dashboard.md) | 必須 | 34mm |
...
|---|---|---|---|---|
| 警告発動時（9 セクション、8 区切り） | 225mm | 24mm（8 × 3mm、注 1） | **249mm** | 18mm 余裕 |
| 警告非発動時（8 セクション、7 区切り） | 211mm | 21mm（7 × 3mm） | **232mm** | 35mm 余裕 |
